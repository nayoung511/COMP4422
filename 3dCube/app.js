...
'',
'attribute vec3 vertPosition;', // 3d
'attribute vec3 vertColor;',
'varying vec3 fragColor;',
'uniform mat4 mWorld;', // rotating cube
...
var InitDemo = function () {
    ...
    var angle = 0;
    var loop = function () {
        angle = performance.now() / 1000 / 6 * 2 * Math.PI //one full rotation
        glMatrix.mat4.rotate(yRotationMatrix, identityMatrix, angle, [0, 1, 0]);
        glMatrix.mat4.rotate(xRotationMatrix, identityMatrix, angle / 4, [1, 0, 0]); // slower
